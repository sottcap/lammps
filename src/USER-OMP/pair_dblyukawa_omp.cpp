...
PairDblYukawaOMP::PairDblYukawaOMP(LAMMPS *lmp) :
  PairDblYukawa(lmp), ThrOMP(lmp, THR_PAIR)
{
...
void PairDblYukawaOMP::compute(int eflag, int vflag)
{
  ev_init(eflag,vflag);
...
void PairDblYukawaOMP::eval(int iifrom, int iito, ThrData * const thr)
{
...
double PairDblYukawaOMP::memory_usage()
{
